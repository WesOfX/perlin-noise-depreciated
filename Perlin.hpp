...
namespace Perlin{
	...
	* reference values from his reference Java implimentation. Using
	...
	* 
	* // Create reference Perlin noise
	* Perlin noise;
	* 
	* // Print noise at 55, 99, 0
	* std::cout << noise.get(55, 99, 0) << std::endl;
	* 
	...
	*/
	...
	// A reference perlin noise generator with a permutation vector
	class Generator{
		// Permutation vector for pseudorandom numbers
	...
	* imediatly call the generate function durring construction. 
	* Examples below.
	*  
